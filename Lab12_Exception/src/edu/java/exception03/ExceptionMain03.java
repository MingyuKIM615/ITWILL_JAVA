 ...
 *    |__Exception
 *       |__RuntimeException
 *          |__ArithmeticExcption, NullPointerExcption, ArrayIndexOutOfBoundsExcption,.....
 *          
 * catch 구문에서 super 타입의 예외로 변수를 선언하면, 그 아래의 모든 sub 타입의 예외들을 모두 잡을 수 있음.
 * (주의) super 타입의 예외를 먼저 catch하면, 그 다음에 나오는 catch 구문에서는 sub타입들을 catch할 수 없음.
 * 
 */
public class ExceptionMain03 {

	public static void main(String[] args) {
		System.out.println("Exception 클래스의 상속 관계");
...
//		catch(ArrayIndexOutOfBoundsException e) //super타입의 예외를 먼저 catch했기 때문에, 아래쪽 catch 블록은 절대 실행될 수 없다.
