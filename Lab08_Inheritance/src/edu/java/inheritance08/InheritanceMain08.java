...
// - 추상 메서드{}가 없기 때문에 반드시 세미콜론(;)으로 선언(문장)을 끝냄.
...
class Dog extends Animal{
	...
	// 추상클래스인 부모로부터 상속받은 추상 메서드를 구현(implement)해야 abstract가 아닌 클래스가 될 수 있음.
	@Override
	public void move() {
