...
public class InheritanceMain06 {
	...
	public static void main(String[] args) {
		...
		// Point 클래스에서  override한 equals() 메서드는 멤버 변수(필드) x, y값으로 같은 지 다른 지를 비교함.
		System.out.println("equals 메서드 : " + pt1.equals(pt2)); 
		
		// Object 클래스의 hashCode() 메서드는 인스턴스가 생성된 메모리 주소값을 리턴하고 있었지만,
		// Point 클래스에서 override한 hashCode() 메서드는 equals()가true일 때 같은 정수 값이 되도록 구현.
		System.out.println(pt1.hashCode());
